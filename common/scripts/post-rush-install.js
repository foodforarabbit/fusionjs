...
function fixSymlinks() {
  try {
    symlinkSync(
      path.resolve(ROOT_DIR, 'public/fusion-cli/bin/cli.js'),
      path.resolve(ROOT_DIR, 'public/create-fusion-app/node_modules/.bin/fusion')
    );
  } catch (e) {}
  ...
  try {
    symlinkSync(
      path.resolve(ROOT_DIR, 'public/fusion-cli/bin/cli.js'),
      path.resolve(ROOT_DIR, 'public/fusion-apollo-universal-client/node_modules/.bin/fusion')
    );
  } catch (e) {}
}
