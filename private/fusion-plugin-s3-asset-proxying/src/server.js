...
const plugin = createPlugin<S3AssetProxyDepsType, S3AssetProxyType>({
  deps: {
    s3Config: S3ConfigToken.optional,
    customViewerResponseHeaders: AssetProxyingResponseHeaderOverrides.optional,
  },
  provides: deps => {
...
export default ((__NODE__ && plugin: any): FusionPlugin<
  S3AssetProxyDepsType,
  S3AssetProxyType
>);
