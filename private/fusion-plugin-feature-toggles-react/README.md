...
```sh
yarn add @uber/fusion-plugin-feature-toggles-react
```
...
If you are using React, we recommend using the supplied `Toggle` component.
...
```js
import {FeatureTogglesClientToken} from '@uber/fusion-plugin-feature-toggles-react';
```
