...
declare module '@apollo/react-hooks' {
  ...
  declare class ObservableQuery<T, V> extends Observable<ApolloQueryResult<T, V>> {
    ...
    observers: Observer<ApolloQueryResult<T, V>>[];
    subscriptionHandles: SubscriptionLINK[];
    lastResult: ApolloQueryResult<T, V>;
    ...
    result(): Promise<ApolloQueryResult<T, V>>;
    currentResult(): ApolloCurrentResult<T>;
    getLastResult(): ApolloQueryResult<T, V>;
    getLastError(): ApolloError;
    resetLastResults(): void;
    refetch(variables?: any): Promise<ApolloQueryResult<T, V>>;
    fetchMore(
      fetchMoreOptions: FetchMoreQueryOptions<any> & FetchMoreOptions<any, any>
    ): Promise<ApolloQueryResult<T, V>>;
